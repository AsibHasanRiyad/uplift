  ...
  return (
    <Navbar className=" min-w-full bg-black bg-opacity-100 rounded-none border-none">
      <div className="container mx-auto flex items-center justify-between ">
        ...
        <button className=" text-3xl font-light " onClick={handelLogout}> <FaSignOutAlt></FaSignOutAlt> </button>
        </Tooltip>
      ...
      <MobileNav open={openNav}>
        ...
        <button className=" text-3xl font-light " onClick={handelLogout}> <FaSignOutAlt></FaSignOutAlt> </button>
          ...
          <NavLink to={"/login"}>
            <h1 className=" text-white cursor-pointer pl-1 text-sm font-normal">Login</h1>
          </NavLink>
        )}
        </div>
      </MobileNav>
