  ...
  return (
    <div className=" flex justify-center items-center py-10">
      ...
      <CardHeader
        ...
        floated={false}
        shadow={false}
        className="m-0 grid bg-[#3BCF92] place-items-center rounded-b-none py-8 px-4 text-center"
      >
        <div className="mb-4 rounded-full border border-white/10 bg-blue-600 p-6 text-white">
          <BanknotesIcon className="h-10 w-10" />
        </div>
        <Typography variant="h4" color="white">
          Donate for helpless people
        </Typography>
      </CardHeader>
      <CardBody>
              ...
              <form className="mt-12 flex flex-col gap-4">
                <div>
                  <Typography
                    variant="small"
                    color="blue-gray"
                    className="mb-4 font-medium text-[#3BCF92] "
                  >
                    Personal Details
                  </Typography>
                ...
                <Button className=" bg-[#3BCF92]" size="lg">Pay Now</Button>
                <Typography
                  variant="small"
                  color="gray"
