...
const Register = () => {
  ...
  const handelRegister = (e) =>{
    ...
    return (
      ...
      <Card className=" md:px-10 md:py-16 rounded-none md:rounded-md" color="white" shadow={false}>
        ...
        className="mt-8 mb-2 px-4 md:px-0 w-80 max-w-screen-lg sm:w-96">
          <div className="mb-4 flex flex-col gap-6 mx-auto">
            <div className=" grid grid-cols-1 md:grid-cols-2 gap-6">
              <Input name="firstName" type="text" className=" col-span-1" label="First Name" />
              <Input name="lastName" type="text" className=" col-span-1 " label="Last Name" />
            </div>
